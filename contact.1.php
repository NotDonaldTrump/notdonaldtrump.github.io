...
<body>
    ...
    <div class="container main-container">
        ...
        <div class="col-md-6">
            ...
            <div class="h-30"></div>
            <p>If you have found a website glitch/bug you can use this form to notify me of the issue, any wesbite suggestions or changes and any questions or doubtful points.</p>
            <p><b>Any job offers or inquiries can also be directed to me via this form.</b></p>
       ...
       $messg = ('./email_template.html');
        ...
        if (isset($_POST['sendmail'])) { mail( $from, 'RE: ' . $subject, $messg, 'From: ' . "no-reply@snotrap.com" );echo "<script>alert('Email sent successfully');</script>";
        }
